        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
                      $check_form = $this->crud_model->get_module_function_for_role('banking_hour', 'form');
                      if ($check_form == true) {
                    ?>
                ...
                <div class="box-body">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $value->sunday_to_thursday_hour ?></td>
                                <td><?php echo $value->friday_hour ?></td>
                            ...
                            ?>
                                    ...
                                    <?php
                              $check_delete = $this->crud_model->get_module_function_for_role('banking_hour', 'soft_delete');
