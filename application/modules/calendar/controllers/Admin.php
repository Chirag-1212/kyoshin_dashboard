...
class Admin extends Auth_controller
{
	...
	public function form($id = '')
	{
		...
		if ($this->input->post()) {
			...
			if ($this->form_validation->run()) {
				...
				$data = array( 
					...
					'calendar_year_id' => $this->input->post('calendar_year_id'),
		...
		$data['calendar'] = 'calendar-form';
		$data['calendar_years'] = $this->crud_model->get_where_order_by('calendar_year', array('status' => '1'), 'title', 'DESC');
		$data['doc_path'] = 'uploads/calendar/';
		$data['page'] = 'form';
