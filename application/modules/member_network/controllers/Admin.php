...
class Admin extends Auth_controller
{
	...
	public function __construct()
	{
		...
		$this->table = 'networks';
		$this->redirect = 'member_network/admin/';
	...
	public function all($page = '')
	{
		...
		$data['page'] = 'list';
		$data['member_network'] = 'member_network-all';
	...
	public function form($id = '')
	{
		...
		$data['categories'] = $this->crud_model->get_where_order_by('member_network_category', array('status' => '1'), 'id', 'ASC');
		$data['title'] = 'Add/Edit ' . $this->title;
		$data['page'] = 'form';
		$data['member_network'] = 'member_network-form';
		$data = array_merge($this->data, $data);
		$this->load->view('layouts/admin/index', $data);
	}
