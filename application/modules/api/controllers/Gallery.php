        ...
        if ($this->request_method != "GET") {
            $response=array(
                ...
                foreach($items as $key=>$val){
                    ...
                    $galleryNe[$key]['description'] = $val->DescriptionNepali;
    ...
    function detail($slug)
    {
        ...
        if ($this->request_method != "GET") {
            ...
            if($slug){
                ...
                $items_nepali = [];
                $multi_images = [];
                $sql = "id, slug, title_nepali , title, description_nepali, description, CoverImage, created,updated";
                ...
                if($detail){
                    ...
                    $items_english['description'] = strip_tags($detail->description);
                    ...
                    $items_nepali['description'] = strip_tags($detail->description_nepali);
