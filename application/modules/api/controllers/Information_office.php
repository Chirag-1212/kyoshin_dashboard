...
class Information_office extends Front_controller
{
    ...
    function detail($slug)
    {
        ...
        if ($this->request_method != "GET") {
            ...
            if($slug){
                $sql_report = "id,slug,DocPath,description,description_nepali, title,title_nepali, created";
                $reportEn = [];
                $reportNe = [];
                $detail = $this->crud_model->getDetail($this->table, array('slug'=>$slug, 'status'=>'1'), $sql_report); 
