    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
                      $check_form = $this->crud_model->get_module_function_for_role('upload_img', 'form');
                      if ($check_form == true) {
                    ?>
                ...
                <div class="box-body">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php if($value->DocPath){ ?><img src="<?php echo base_url(). $value->DocPath; ?>"
                                        class="img-fluid" style="max-height: 150px;object-fit: contain;"><?php } ?></td>
                                <td><?php echo base_url(). $value->DocPath; ?></br><button class="copy-button" onclick="copyLink('<?php echo base_url(). $value->DocPath; ?>')">Copy Link</button>
        <?php //echo $value->created ?></td>
                            ...
                            ?>
                                    ...
                                    <?php
                              $check_delete = $this->crud_model->get_module_function_for_role('upload_img', 'hard_delete');
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?php echo base_url($redirect.'hard_delete/'.$value->id); ?>"
