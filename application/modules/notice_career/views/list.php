            ...
            <div class="box">
                ...
                <div class="box-body">
                        ...
                        <tbody>
                          ...
                          if ($items) {
                            ...
                            foreach ($items as $key => $value) { 
                                ...
                                $offset = $offset + $i;
                              if ($value->status == '1') {
                                    $status = '<span class="label label-success">Notice Only</span>';
                                } else if ($value->status == '3') {
                                    $status = '<span class="label label-success">Popup & Notice </span>';
                    ...
                    <?php endif; ?></td>
                                ...
                                <td><?php echo $value->imp_notice; ?></td>
                                <td><?php echo $value->show_pop; ?></td>
