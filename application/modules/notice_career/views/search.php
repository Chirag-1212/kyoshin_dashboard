...
<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?php echo base_url('notice_career/admin/search'); ?> " method="post">
                 ...
                 <div class="col-sm-6">
                     <div class="form-group">
                        ...
                        <select name="Type" class="form-control selct2" id="Type">
                          <option value="notice" <?php echo  set_select('Type', 'news', (isset($detail->Type) && $detail->Type == 'news') ? TRUE : ''); ?>>News & Events </option>
                          <option value="notice" <?php echo  set_select('Type', 'notice', (isset($detail->Type) && $detail->Type == 'notice') ? TRUE : ''); ?>>Notice</option>
                          <option value="career" <?php echo  set_select('Type', 'career', (isset($detail->Type) && $detail->Type == 'career') ? TRUE : ''); ?>>Career</option>
                        </select>
                    </div>
                </div>
                <div class="col-sm-6">
