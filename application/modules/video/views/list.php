        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
                      $check_form = $this->crud_model->get_module_function_for_role('video', 'form');
                      if ($check_form == true) {
                    ?>
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php if($value->featured_image){ ?><img src="<?php echo base_url().$value->featured_image; ?>"
                            ...
                            ?>
                                    ...
                                    <?php
                              $check_delete = $this->crud_model->get_module_function_for_role('video', 'soft_delete');
