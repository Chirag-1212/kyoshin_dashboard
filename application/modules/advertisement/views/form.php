                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Where To List?</label>
                                    <?php $types = ['banner', 'about-us', 'services', 'our-network']; ?>
                                    <select name="type" class="form-control select2" id="type">
                                        <option value=""> Select Listed </option>
                                        <?php for($i = 0; $i < count($types); $i++){
                                        ?>
                                        <option value="<?php echo $types[$i]; ?>"
                                            <?php echo set_select('type', $types[$i],isset($detail->type) ? $types[$i] == $detail->type ? true : false : false) ?>>
                                            <?php echo ucwords(str_replace("-"," ",$types[$i])); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
