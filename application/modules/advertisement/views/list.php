        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
                      $check_form = $this->crud_model->get_module_function_for_role('advertisement', 'form');
                      if ($check_form == true) {
                    ?>
                    ...
                    <div class="box-tools">
                        <form action="" method="get">
                            <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                                ...
                                <input type="text" name="title" class="form-control pull-right" placeholder="Search"
                ...
                <div class="box-body">
                    ...
                    ?>
                            ...
                            ?>
                                    ...
                                    <?php
                              $check_delete = $this->crud_model->get_module_function_for_role('advertisement', 'soft_delete');
