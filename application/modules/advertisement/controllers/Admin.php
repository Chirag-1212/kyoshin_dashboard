...
class Admin extends Auth_controller {
	...
	public function __construct()
	{
		...
		$this->redirect = 'advertisement/admin/';
	...
	{ 
		...
		$config['suffix'] = isset($title)?"?title=$title":'';
...
// 		var_dump($data['items']);exit;
		...
		$data['offset'] = $page;
		$data['advertisement'] = 'advertisement-all';
	...
	{ 
		...
		$doc_path='uploads/advertisement/';
		if($this->input->post()){
			...
			if($this->form_validation->run()){
				...
				// 	    echo "<pre>";
				// 	var_dump($this->db->last_query(), $data);exit;
		...
		$data['advertisement'] = 'advertisement-form';
		$data = array_merge($this->data, $data);
        $this->load->view('layouts/admin/index',$data);
	}
