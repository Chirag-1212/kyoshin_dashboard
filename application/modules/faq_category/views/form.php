                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control" id="title" placeholder="Faq Category Title" value="<?php echo (((isset($detail->title)) && $detail->title != '')? $detail->title : '') ?>">
                    </div> 
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Title Nepali</label>
                      <input type="text" name="title_nepali" class="form-control" id="title_nepali" placeholder="Faq Category Title Nepali" value="<?php echo (((isset($detail->title_nepali)) && $detail->title_nepali != '')? $detail->title_nepali : '') ?>">
                    </div> 
                  </div>
                </div>    
                <div class="row">
                ...
                <div class="row">  
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="order_no" class="form-control" id="order_no" placeholder="Rank Order No" value="<?php echo (((isset($detail->order_no)) && $detail->order_no != '')? $detail->order_no : '') ?>">
                    </div> 
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
