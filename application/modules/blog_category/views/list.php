        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
                      $check_form = $this->crud_model->get_module_function_for_role('blog_category', 'form');
                      if ($check_form == true) {
                    ?>
                    ...
                    <?php } ?>
                    <div class="box-tools">
                        <form action="<?php echo base_url('blog_category/admin/search'); ?> " method="get">
                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        if(!empty($items)){ 
                            ...
                            ?>
                                    ...
                                    <?php
                              $check_delete = $this->crud_model->get_module_function_for_role('blog_category', 'soft_delete');
