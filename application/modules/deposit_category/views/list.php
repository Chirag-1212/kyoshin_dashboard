                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                        $check_content_edit = $this->crud_model->get_module_function_for_role($redirect, $edit_check_value);
                        if ($check_content_edit == true) {
                        ?>
                                    <a href="<?php echo base_url($edit_link . $value->id); ?>"
                                        class="btn bg-purple btn-flat margin"><i class="fa fa-edit"></i></a>
                                    <?php } ?>
                                    <?php
                        $check_content_soft_delete = $this->crud_model->get_module_function_for_role($redirect,$delete_check_value);
