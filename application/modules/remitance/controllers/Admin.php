...
class Admin extends Auth_controller {
	...
	public function __construct()
	{
		...
		$this->table = 'remitance';
		$this->redirect = 'remitance/admin/';
		$this->title = 'Remitance';
