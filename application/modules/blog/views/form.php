                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo base_url(). $detail->featured_image; ?>" class="img_cl img-fluid" id="defff0"
                                        style="max-height: 675px;object-fit: contain;">
                                    <?php }else{ ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="blog_cat" class="form-control select2" id="blog_cat">
                                        <option value>Select Category</option>
                                        <?php foreach ($blog_category as $key => $value) { ?>
                                        <option value="<?php echo $value->id ?>"
                                            <?php echo (((isset($detail->blog_cat)) && $detail->blog_cat == $value->id) ? 'selected' : '') ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description_nepali" id="DescriptionNepali" class="form-control" rows="5"
                                        cols="80"
