...
class Admin extends Auth_controller
{
	...
	public function __construct()
	{
		...
		$this->table = 'member_network_category';
		$this->redirect = 'member_network_category/admin/';
		$this->title = 'Member Network Category';
	...
	public function all($page = '')
	{
		...
		$data['member_network'] = 'member_network-category';
