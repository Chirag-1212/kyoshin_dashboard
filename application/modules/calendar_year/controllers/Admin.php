...
class Admin extends Auth_controller
{
	...
	public function __construct()
	{
		...
		$this->table = 'calendar_year';
		$this->redirect = 'calendar_year/admin/';
		$this->title = 'Calendar Year';
	...
	public function all($page = '')
	{
		...
		$data['calendar_year'] = 'calendar_year-all';
	...
	public function form($id = '')
	{
		...
		if ($this->input->post()) {
			...
			if ($this->form_validation->run()) {
				...
				if($this->input->post('is_current') == 'Yes'){
			        ...
			        $this->crud_model->update('calendar_year',$update,array('status'=>'1'));
			    }
				if ($id == '') {  
		...
		$data['calendar_year'] = 'calendar_year-form';
