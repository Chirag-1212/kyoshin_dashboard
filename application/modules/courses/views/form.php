                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sub_level" class="form-control" placeholder="Enter Sub-Level" 
                                        value="<?php echo isset($detail->sub_level) ? $detail->sub_level : ''; ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Sub-Text (English)</label>
                                    <input type="text" name="sub_text_en" class="form-control" placeholder="Enter English Sub-Text" 
                                        value="<?php echo isset($detail->sub_text_en) ? $detail->sub_text_en : ''; ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Sub-Text (Japanese)</label>
                                    <input type="text" name="sub_text_jp" class="form-control" placeholder="Enter Japanese Sub-Text" 
                                        value="<?php echo isset($detail->sub_text_jp) ? $detail->sub_text_jp : ''; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="desc_en" class="form-control" rows="10" placeholder="Write English description here..."><?php echo isset($detail->desc_en) ? $detail->desc_en : ''; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Description (Japanese)</label>
                                    <textarea name="desc_jp" class="form-control" rows="10" placeholder="Write Japanese description here..."><?php echo isset($detail->desc_jp) ? $detail->desc_jp : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (!empty($detail->docpath)) { ?>
                                        <div style="margin-top: 10px;">
                                            <img src="<?php echo base_url($detail->docpath); ?>" 
