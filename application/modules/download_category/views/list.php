        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
                      $check_form = $this->crud_model->get_module_function_for_role('download_category', 'form');
                      if ($check_form == true) {
                    ?>
                ...
                <div class="box-body">
                    ...
                    ?>
                            ...
                            ?>
                                    ...
                                    <?php
                              $check_delete = $this->crud_model->get_module_function_for_role('download_category', 'soft_delete');
