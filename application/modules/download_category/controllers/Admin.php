...
class Admin extends Auth_controller
{
	...
	public function __construct()
	{
		...
		$this->table = 'download_category';
		$this->redirect = 'download_category/admin/';
		$this->title = 'Downlaod Category';
		$this->userId = $this->data['userId'];
	}
    
    
	
	public function old_all($page = '')
	{
		...
		$data['page'] = 'list';
		$data['download'] = 'download-category';
	...
	{  
		...
		$page = ($this->uri->segment(4)) ? $this->uri->segment(4) : 0;
		$items = $this->crud_model->getData($this->table, $param, $like, $config["per_page"], $page, '*', 'created DESC');
