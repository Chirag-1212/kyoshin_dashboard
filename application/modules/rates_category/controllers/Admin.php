...
class Admin extends Auth_controller
{
	...
	public function __construct()
	{
		...
		$this->redirect = 'rates_category/admin/';
		$this->title = 'Rates Category';
	...
	public function all($page = '')
	{
		...
		$data = array_merge($this->data,[
			...
			'offset'=>$page,
			'title'=>'Rates Category',
			'page'=>'list',
			'rates'=>'rates-category',
			
		]);
// 		$data['pagination'] = $this->pagination->create_links();
// 		$data['offset'] = $page;
// 		$data['title'] = 'Rates Category';
// 		$data['page'] = 'list';
// 		$data['type'] = '';
// 		$data['rates'] = 'rates-category';
