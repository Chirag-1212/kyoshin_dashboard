        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
              $check_form = $this->crud_model->get_module_function_for_role('product_category', 'form');
              if ($check_form == true) {
              ?>
                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if ($value->featured_image) { ?><img
                                        src="<?php echo base_url().$value->featured_image; ?>" class="img-fluid"
                                        style="max-height: 150px;object-fit: contain;"><?php } ?></td>
                        ...
                        ?>
                                    ...
                                    <?php
                        $check_delete = $this->crud_model->get_module_function_for_role('product_category', 'soft_delete');
