...
<script type="text/javascript">
    ...
    $('document').ready(function () {
        ...
        if ($("textarea#content").length > 0) {
            ...
            $('textarea#content').attr('id', 'content');
        ...
        if ($("textarea#content1").length > 0) {

            $('textarea#content1').attr('id', 'content1');
        ...
        if ($("textarea#content2").length > 0) {

            $('textarea#content2').attr('id', 'content2');
        ...
        if ($("textarea#content3").length > 0) {

            $('textarea#content3').attr('id', 'content3');
        ...
        if ($("textarea#content4").length > 0) {

            $('textarea#content4').attr('id', 'content4');
        ...
        //CKFinder.setupCKEditor(editor, '<?php //echo base_url()?>//uploads');
